EXTRA_STOPWORDS = [
    'sr.', 'nesse', 'deputados', '``', "''", 'empresa', 'trabalhadores', 'tema',
    ...
    'debate', 'entregar', 'nessa', 'nome', 'vez', 'quer', 'primeira',
    ...
    'presença', 'deputados', 'vou', 'brasil', 'discutir', 'vigência', 'colocar',
    'regimento', 'momento', ';', 'dois', 'dessa', 'medida', 'proposta', 'casa',
    'matéria', 'queria', 'assim', 'possamos', 'microfone', 'certeza', 'hoje',
    'profissional', 'deixar', 'provisória', 'ora', 'base', 'importante', 'veto',
    ...
    'nº', 's.a.', 'v.exa.', 'v.exa', '#', 'anos', 'º', 'exa', 'mesa',
    ...
    'pasta', 'milhares', 'srªs', 'emenda', 'àqueles', 'tamanha', 'mês', 'capaz',
    ...
    'lider', 'frente', 'governo', 'oposição', 'presença', 'presente', 'passado',
    'ausência', 'ausencia', 'ausente', 'obstrução', 'registrar', 'aprovar',
    'rejeitar', 'rejeição', 'sabe', 'matéria', 'materia', 'questão', 'ordem',
    'emenda', 'sistema', 'processo', 'legislativo', 'plenário', 'pedir', 'peço',
    'comissão', 'especial', 'permanente', 'apresentar', 'encaminhar',
    'encaminho', 'orientar', 'liberar', 'apoiar', 'situação', 'fato', 'revisão',
    ...
    'necessárias', 'presidenta', 'compromisso', 'geradas', 'primeiro',
    'simplesmente', 'ideal', 'argumento', 'i', 'válido', 'envolvidos', 'nesse',
    'aspecto', 'existentes', 'normativo', 'irá', 'nada', 'melhor', 'esperarmos',
...
ONEGRAM_STOPWORDS = [
    'grande', 'nacional', 'são', 'e', 'de', 'das', 'dos', 'da', 'do', 'federal',
    ...
    'município', 'prefeito', 'ii', 'santa', 'vereadora', 'centro', 'prefeitura',
    ...
    'decisão', 'mulher', 'nobre', 'capital', 'aprovação', 'humanos', 'estadual',
